...
namespace ipc
{
    ...
    public:
        ...
        {
            if (ipc::args_check<ARGS...>::has_out_)
            {
    ...
    private:
        ...
        int resolve(const bool _has_out, const std::string &_path, const std::string &_iface, const std::string &_member, 
            T1 &_t1)
        {
            typename ipc::type_redefine<T1>::type tt1 = _t1;
        ...
        {
            typename ipc::type_redefine<T1>::type tt1 = _t1;
            typename ipc::type_redefine<T2>::type tt2 = _t2;
            ...
            T1 &_t1, T2 &_t2, T3 &_t3)
        {
            typename ipc::type_redefine<T1>::type tt1 = _t1;
            typename ipc::type_redefine<T2>::type tt2 = _t2;
            typename ipc::type_redefine<T3>::type tt3 = _t3;
            ...
            T1 &_t1, T2 &_t2, T3 &_t3, T4 &_t4)
        {
            ...
            typename ipc::type_redefine<T2>::type tt2 = _t2;
            typename ipc::type_redefine<T3>::type tt3 = _t3;
            typename ipc::type_redefine<T4>::type tt4 = _t4;
            ...
            T1 &_t1, T2 &_t2, T3 &_t3, T4 &_t4, T5 &_t5)
        {
            ...
            typename ipc::type_redefine<T2>::type tt2 = _t2;
            typename ipc::type_redefine<T3>::type tt3 = _t3;
            typename ipc::type_redefine<T3>::type tt4 = _t4;
            typename ipc::type_redefine<T5>::type tt5 = _t5;
            ...
            T1 &_t1, T2 &_t2, T3 &_t3, T4 &_t4, T5 &_t5, T6 &_t6)
        {
            ...
            typename ipc::type_redefine<T3>::type tt4 = _t4;
            typename ipc::type_redefine<T5>::type tt5 = _t5;
            typename ipc::type_redefine<T6>::type tt6 = _t6;
            ...
            T1 &_t1, T2 &_t2, T3 &_t3, T4 &_t4, T5 &_t5, T6 &_t6, T7 &_t7)
        {
            ...
            typename ipc::type_redefine<T5>::type tt5 = _t5;
            typename ipc::type_redefine<T6>::type tt6 = _t6;
            typename ipc::type_redefine<T7>::type tt7 = _t7;
            ...
            T1 &_t1, T2 &_t2, T3 &_t3, T4 &_t4, T5 &_t5, T6 &_t6, T7 &_t7, T8 &_t8)
        {
            ...
            typename ipc::type_redefine<T6>::type tt6 = _t6;
            typename ipc::type_redefine<T7>::type tt7 = _t7;
            typename ipc::type_redefine<T7>::type tt8 = _t8;
            ...
            T1 &_t1, T2 &_t2, T3 &_t3, T4 &_t4, T5 &_t5, T6 &_t6, T7 &_t7, T8 &_t8, T9 &_t9)
        {
            ...
            typename ipc::type_redefine<T7>::type tt7 = _t7; 
            typename ipc::type_redefine<T7>::type tt8 = _t8;
            typename ipc::type_redefine<T7>::type tt9 = _t9;
            ...
            T1 &_t1, T2 &_t2, T3 &_t3, T4 &_t4, T5 &_t5, T6 &_t6, T7 &_t7, T8 &_t8, T9 &_t9, T10 &_t10)
        {
            ...
            typename ipc::type_redefine<T7>::type tt8 = _t8;
            typename ipc::type_redefine<T7>::type tt9 = _t9;
            typename ipc::type_redefine<T7>::type tt10 = _t10;
